		...
		<div class='pad1'>
			...
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">11.27% </span> <span class="quiet">Statements</span>
					<span class='fraction'>8/71</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">0% </span> <span class="quiet">Branches</span>
					<span class='fraction'>0/32</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">0% </span> <span class="quiet">Functions</span>
					<span class='fraction'>0/14</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">12.5% </span> <span class="quiet">Lines</span>
 ...
 */
module.exports = function <span class="fstat-no"
								title="function not covered">completion(</span>) {
...
<span class="cstat-no" title="statement not covered">            if(process.platform === 'win32') {</span>
                const e = <span class="cstat-no"
								title="statement not covered">new Error('shell completion not supported on windows');</span>
...
&nbsp;
            // cmd
            const parsed = <span class="cstat-no"
								title="statement not covered">this._cmd._parseCmd(opts.partialWords);</span>
<span class="cstat-no" title="statement not covered">            return Q.when(complete(parsed.cmd, parsed.opts), <span
								class="fstat-no" title="function not covered">(c</span>ompls) =&gt; {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    fs.readFile(path.resolve(__dirname, 'completion.sh'), 'utf8', <span
								class="fstat-no" title="function not covered">fu</span>nction(err, d) {</span>
<span class="cstat-no" title="statement not covered">        if(err) <span
								class="cstat-no" title="statement not covered">return defer.reject(err);</span></span>
...
<span class="cstat-no" title="statement not covered">        process.stdout.write(d, <span
								class="fstat-no" title="function not covered">()</span> =&gt; <span
								class="cstat-no" title="statement not covered">defer.resolve())</span>;</span>
    });
&nbsp;
...
<span class="cstat-no" title="statement not covered">        if(err.errno !== constants.EPIPE) <span
								class="cstat-no" title="statement not covered">return defer.reject(err);</span></span>
...
function <span class="fstat-no" title="function not covered">getOpts(</span>argv) {
    ...
    const partialLine = <span class="cstat-no"
								title="statement not covered">line.substr(0, point);</span>
    const partialWords = <span class="cstat-no"
								title="statement not covered">words.slice(0, w);</span>
&nbsp;
    // figure out where in that last word the point is
    let partialWord = <span class="cstat-no"
								title="statement not covered">argv[w] || '';</span>
...
<span class="cstat-no" title="statement not covered">    while(partialWord.substr(0, i) !== partialLine.substr(-1 * i) &amp;&amp; i &gt; 0) <span
								class="cstat-no" title="statement not covered">i--;</span></span>
&nbsp;
...
<span class="fstat-no" title="function not covered">                (c</span>, o) =&gt; <span
								class="cstat-no" title="statement not covered">c.concat(o.map(<span
								class="fstat-no" title="function not covered">v </span>=&gt; <span
								class="cstat-no" title="statement not covered">(optPrefix || '') + v)</span>))</span>));
&nbsp;
    // TODO: complete on args values (context aware, custom completion?)
&nbsp;
    // custom completion on cmds
<span class="cstat-no" title="statement not covered">    cmd._comp &amp;&amp; (compls = Q.join(compls, Q.when(cmd._comp(opts)), <span
								class="fstat-no" title="function not covered">(c</span>, o) =&gt; <span
								class="cstat-no" title="statement not covered">c.concat(o))</span>);</span>
&nbsp;
    // TODO: context aware custom completion on cmds, opts and args
    // (can depend on already entered values, especially options)
&nbsp;
<span class="cstat-no" title="statement not covered">    return Q.when(compls, <span
								class="fstat-no" title="function not covered">co</span>mplitions =&gt; {</span>
...
<span class="cstat-no" title="statement not covered">        return compls.filter(<span
								class="fstat-no" title="function not covered">(c</span>) =&gt; <span
								class="cstat-no" title="statement not covered">c.indexOf(opts.partialWord) === 0)</span>;</span>
    });
}
&nbsp;</pre></td>
				</tr>
