	...
	<div class='wrapper'>
		<div class='pad1'>
			...
			<div class='clearfix'>
				...
				<div class='fl pad1y space-right2'>
					<span class="strong">72.73% </span> <span class="quiet">Branches</span>
				...
				<div class='fl pad1y space-right2'>
					<span class="strong">95.65% </span> <span class="quiet">Lines</span>
...
&nbsp;
    ...
    act(act) {
        this._cmd.act((opts) =&gt; {
            <span class="missing-if-branch" title="if path not taken">I</span>if(!opts.hasOwnProperty(this._name)) <span
								class="cstat-no" title="statement not covered">return;</span>
&nbsp;
            const res = act.apply(this._cmd, arguments);
            <span class="missing-if-branch" title="if path not taken">I</span>if(!this._only) <span
