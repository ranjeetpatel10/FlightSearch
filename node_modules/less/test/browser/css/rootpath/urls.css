...
@font-face {
	...
	src: local(Futura-Medium),
		url(https://localhost/fonts.svg#MyGeometricModern) format("svg");
}
...
.comma-delimited {
	background: url(https://localhost/bg.jpg) no-repeat,
		url(https://localhost/bg.png) repeat-x top left,
		url(https://localhost/bg);
}
