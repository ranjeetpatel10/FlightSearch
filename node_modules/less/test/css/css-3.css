.comma-delimited {
	...
	-moz-box-shadow: 0pt 0pt 2px rgba(255, 255, 255, 0.4) inset, 0pt 4px 6px
...
@
keyframes fontbulger1 {to { font-size:15px;
...
supports ( box-shadow: 2px 2px 2px black ) or
          ( -moz-box-shadow: 2px 2px 2px black ) { .outline {
...
.shadow ^ .dom, body ^^ .shadow {
	display: done;
}

:host (.sel .a ), :host-context (.sel .b ), .sel /deep/ .b, ::content .sel
	{
	type: shadow-dom;
}
