...
.foo a>.foo a, .foo a>.bar a, .foo a>.foo b, .foo a>.bar b, .bar a>.foo a,
	.bar a>.bar a, .bar a>.foo b, .bar a>.bar b, .foo b>.foo a, .foo b>.bar a,
	.foo b>.foo b, .foo b>.bar b, .bar b>.foo a, .bar b>.bar a, .bar b>.foo b,
	.bar b>.bar b {
	background: amber;
}
...
[prop], [prop= 10%], [prop ="value3"], [prop*="val3"], [ |prop~="val3"],
	[ *|prop$="val3"], [ns |prop^="val3"], [ 3^="val3 "], [ 3=3], [ 3] {
	attributes: yes;
}
/*
...
.extend-this, .active.first-level .second-level, .first-level .second-level.active2
	{
	content: '\2661';
}