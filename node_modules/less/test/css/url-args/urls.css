@font-face {
	...
	src: local(Futura-Medium), url(fonts.svg?424242#MyGeometricModern)
		format("svg");
}

#shorthands {
	background: url("http://www.lesscss.org/spec.html?424242") no-repeat 0
		4px;
	background: url("img.jpg?424242") center/100px;
	background: #fff url(image.png?424242) center/1px 100px repeat-x scroll
...
.comma-delimited {
	background: url(bg.jpg?424242) no-repeat, url(bg.png?424242) repeat-x
		top left, url(bg?424242);
}
...
#data-uri-with-spaces {
	background-image: url(data:image/x-png,f9difSSFIIGFIFJD1f982FSDKAA9==);
	background-image:
		url(' data:image/x-png,f9difSSFIIGFIFJD1f982FSDKAA9==');
}