...
@font-face {
	...
	src: local(Futura-Medium), url(fonts.svg#MyGeometricModern)
		format("svg");
	not-a-comment: url(//z);
}
...
#shorthands {
	...
	background: #fff url(image.png) center/1px 100px repeat-x scroll
...
#svg-data-uri {
	background: transparent
		url('data:image/svg+xml, <svg version="1.1"><g></g></svg>');
}

.comma-delimited {
	background: url(bg.jpg) no-repeat, url(bg.png) repeat-x top left,
		url(bg);
}
...
#data-uri-ascii {
	uri-1:
		url("data:text/html,%3Chtml%3E%3Ch1%3EThis%20page%20is%20100%25%20Awesome.%3C%2Fh1%3E%3C%2Fhtml%3E%0A");
	uri-2:
		url("data:text/html,%3Chtml%3E%3Ch1%3EThis%20page%20is%20100%25%20Awesome.%3C%2Fh1%3E%3C%2Fhtml%3E%0A");
}
...
#file-functions {
	...
	svg-not-base-64:
		url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%20standalone%3D%22no%22%3F%3E%0A%3Csvg%20height%3D%22100%22%20width%3D%22100%22%3E%0A%20%20%3Ccircle%20cx%3D%2250%22%20cy%3D%2250%22%20r%3D%2240%22%20stroke%3D%22black%22%20stroke-width%3D%221%22%20fill%3D%22blue%22%20%2F%3E%0A%3C%2Fsvg%3E%0A");
	size: 640px 430px;
	width: 640px;
	height: 430px;
}
...
@font-face {
	...
	src: url('webfont.eot?#iefix') format('embedded-opentype'),
		url('webfont.woff') format('woff'), format('truetype')
		url('webfont.ttf'), url('webfont.svg#svgFontName') format('svg');
}