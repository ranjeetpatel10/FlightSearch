...
a, .mdl-accordion, .mdl-button, .mdl-card, .mdl-checkbox,
	...
	.mdl-slider, .mdl-switch, .mdl-tabs__tab {
...
.mdl-badge.mdl-badge--no-background[data-badge]:after {
	color: rgb($ color-accent);
	background: rgba($ color-accent-contrast, 0.2);
...
.mdl-mega-footer--top-section:after, .mdl-mega-footer--middle-section:after,
	.mdl-mega-footer--bottom-section:after, .mdl-mega-footer__top-section:after,
...
.mdl-mega-footer--heading-checkbox:checked ~ .mdl-mega-footer--link-list,
	...
	.mdl-mega-footer__link-list, .mdl-mega-footer--heading-checkbox:checked+.mdl-mega-footer--heading+.mdl-mega-footer--link-list,
	.mdl-mega-footer--heading-checkbox:checked+.mdl-mega-footer__heading+.mdl-mega-footer__link-list,
	.mdl-mega-footer__heading-checkbox:checked ~
	.mdl-mega-footer--link-list, .mdl-mega-footer__heading-checkbox:checked 
	~ .mdl-mega-footer__link-list, .mdl-mega-footer__heading-checkbox:checked+.mdl-mega-footer--heading+.mdl-mega-footer--link-list,
...
@media screen and (min-width: 760px) {
	...
	.mdl-mega-footer--heading-checkbox:checked ~ .mdl-mega-footer--link-list,
		.mdl-mega-footer--heading-checkbox:checked ~
		.mdl-mega-footer__link-list, .mdl-mega-footer--heading-checkbox:checked+.mdl-mega-footer__heading+.mdl-mega-footer__link-list,
		.mdl-mega-footer--heading-checkbox:checked+.mdl-mega-footer--heading+.mdl-mega-footer--link-list,
		.mdl-mega-footer__heading-checkbox:checked ~
		.mdl-mega-footer--link-list, .mdl-mega-footer__heading-checkbox:checked 
		~ .mdl-mega-footer__link-list, .mdl-mega-footer__heading-checkbox:checked+.mdl-mega-footer__heading+.mdl-mega-footer__link-list,
...
.mdl-icon-toggle__label {
	...
	transition: background-color 0.2s cubic-bezier(0.4, 0, 0.2, 1), color
...
.mdl-menu.is-animating {
	transition: opacity 0.2s cubic-bezier(0.4, 0, 0.2, 1), clip 0.3s
		cubic-bezier(0.4, 0, 0.2, 1);
}
...
.mdl-progress>.bufferbar {
	background-image: linear-gradient(to right, rgba($ color-primary-contrast, 0.7),
		rgba($ color-primary-contrast, 0.7)),
		linear-gradient(to right, rgb($ color-primary), rgb($ color-primary));
	z-index: 0;
	left: 0;
}
...
supports (-webkit-appearance: none ) { .
	mdl-progress: not(.mdl-progress--indeterminate):not(.mdl-progress--indeterminate)>
		 .auxbar, .mdl-progress:not(.mdl-progress__indeterminate):not(.mdl-progress__indeterminate)>
		 .auxbar{
    background-image: linear-gradient(to right, rgba($ color-primary-contrast, 0.7),
		rgba($ color-primary-contrast, 0.7)),
		linear-gradient(to right, rgb($ color-primary), rgb($ color-primary));
...
.mdl-progress:not (.mdl-progress--indeterminate ) >.auxbar,
	...
	background-image: linear-gradient(to right, rgba($ color-primary-contrast, 0.9),
...
@
-webkit-keyframes indeterminate2 { 0% {
	left: 0%;
	width: 0%;
}
...
@
supports (pointer-events: auto ) { .mdl-layout__obfuscator {
	background-color:rgba(0, 0, 0, 0.5);
	opacity: 0;
...
.mdl-slider.is-upgraded::-ms-fill-lower {
	padding: 0;
	background: linear-gradient(to right, transparent, transparent 16px, rgb($
		color-primary) 16px, rgb($ color-primary) 0);
}

.mdl-slider.is-upgraded::-ms-fill-upper {
	padding: 0;
	background: linear-gradient(to left, transparent, transparent 16px, rgba(0, 0, 0,
		0.26) 16px, rgba(0, 0, 0, 0.26) 0);
}
...
.mdl-slider.is-upgraded::-webkit-slider-thumb {
	...
	background: rgb($ color-primary);
	border: none;
	transition: border 0.18s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.18s
		cubic-bezier(0.4, 0, 0.2, 1), background 0.28s
		cubic-bezier(0.4, 0, 0.2, 1), -webkit-transform 0.18s
		cubic-bezier(0.4, 0, 0.2, 1);
	transition: transform 0.18s cubic-bezier(0.4, 0, 0.2, 1), border 0.18s
		cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.18s
		cubic-bezier(0.4, 0, 0.2, 1), background 0.28s
		cubic-bezier(0.4, 0, 0.2, 1);
	transition: transform 0.18s cubic-bezier(0.4, 0, 0.2, 1), border 0.18s
		cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.18s
...
.mdl-slider.is-upgraded::-ms-thumb {
	...
	transition: transform 0.18s cubic-bezier(0.4, 0, 0.2, 1), background
		0.28s cubic-bezier(0.4, 0, 0.2, 1), -webkit-transform 0.18s
		cubic-bezier(0.4, 0, 0.2, 1);
}

.mdl-slider.is-upgraded:focus:not (:active )::-ms-thumb {
	background: radial-gradient(circle closest-side, rgb($ color-primary) 0%,
		rgb($ color-primary) 37.5%, rgba($ color-primary, 0.26) 37.5%,
		rgba($ color-primary, 0.26) 100%);
	transform: scale(1);
}
...
.mdl-slider.is-upgraded.is-lowest-value:focus:not (:active )::-ms-thumb
	...
	background: radial-gradient(circle closest-side, rgba(0, 0, 0, 0.12) 0%,
		rgba(0, 0, 0, 0.12) 25%, rgba(0, 0, 0, 0.26) 25%, rgba(0, 0, 0, 0.26)
		37.5%, rgba(0, 0, 0, 0.12) 37.5%, rgba(0, 0, 0, 0.12) 100%);
	transform: scale(1);
}
...
.mdl-slider.is-upgraded:disabled:focus::-moz-range-thumb, .mdl-slider.is-upgraded:disabled:active::-moz-range-thumb,
...
.mdl-slider.is-upgraded:disabled:focus::-ms-thumb, .mdl-slider.is-upgraded:disabled:active::-ms-thumb,
...
@
-webkit-keyframes mdl-spinner__container-rotate {to { -webkit-transform:rotate(360deg);
	transform: rotate(360deg);
}

}
@
keyframes mdl-spinner__container-rotate {to { -webkit-transform:rotate(360deg);
	transform: rotate(360deg);
}
...
*/
@
-webkit-keyframes mdl-spinner__layer-1-fade-in-out {from { opacity:0.99;
...
@
keyframes mdl-spinner__layer-1-fade-in-out {from { opacity:0.99;
...
@
-webkit-keyframes mdl-spinner__layer-2-fade-in-out {from { opacity:0;
...
@
-webkit-keyframes mdl-spinner__layer-3-fade-in-out {from { opacity:0;
...
@
-webkit-keyframes mdl-spinner__layer-4-fade-in-out {from { opacity:0;
...
@
-webkit-keyframes mdl-spinner__left-spin {from { -webkit-transform:rotate(130deg);
...
@
-webkit-keyframes mdl-spinner__right-spin {from { -webkit-transform:rotate(-130deg);
	transform: rotate(-130deg);
}
...
@
keyframes mdl-spinner__right-spin {from { -webkit-transform:rotate(-130deg);
	transform: rotate(-130deg);
}
