...
.docs-layout-header .docs-navigation .github, .docs-layout-header .docs-navigation .download
	{
	text-transform: none
}
...
.started .docs-layout-header.mdl-layout__header, .faq .docs-layout-header.mdl-layout__header
	{
...
.docs-navigation .mdl-navigation__link:hover, .docs-navigation .mdl-navigation__link.download:hover>span,
...
.docs-navigation .mdl-navigation__link:not (.download ),
	.docs-navigation .mdl-navigation__link.download>span, .docs-navigation .mdl-navigation__link.download>.material-icons
	{
	opacity: .65
}
...
.about .docs-navigation .about, .templates .docs-navigation .templates,
	.showcase .docs-navigation .showcase, .started .docs-navigation .started,
	.styles .docs-navigation .styles, .components .docs-navigation .components,
	.faq .docs-navigation .faq, .customize .docs-navigation .customize {
	opacity: 1;
...
.docs-layout.is-small-screen .about-panel--text dd, .docs-layout.is-small-screen .about-panel--text dt
	{
	margin: 0;
	padding: 0;
	text-align: left;
...
.about-panel--components, .about-panel--styles {
	height: 500px
}

.about-panel--components, .about-panel--styles, .about-panel--customize,
...
.image-preloader {
	...
	top: -100px;
	left: -100px;
	background-image: url(templates_mo.svg), url(components_mo.svg),
		url(styles_mo.svg), url(customize_mo.svg)
}
...
.docs-text-styling h1, .docs-text-styling h2, .docs-text-styling h3,
...
.social-btn__twitter {
	background-image:
		url('https://www.gstatic.com/images/icons/material/system/2x/post_twitter_white_24dp.png')
}
...
.social-btn__gplus {
	background-image:
		url('https://www.gstatic.com/images/icons/material/system/2x/post_gplus_white_24dp.png')
}
...
.about .subpageheader, .components .subpageheader {
	display: none
}

.started .subpageheader, .customize .subpageheader, .styles .subpageheader,
	.faq .subpageheader, .templates .subpageheader, .showcase .subpageheader
	{
	width: 960px;
	margin: 40px auto
}
...
.snippet-group .snippet-demo-padding, .snippet-group .snippet-caption,
...
.codepen-button {
	...
	transition: right .5s, background-color .5s, opacity .5s,
		background-size .3s
}
...
.docs-layout code, .docs-layout pre {
	display: inline-block;
...
.docs-layout code:before, .docs-layout code:after {
	letter-spacing: -.2em;
	content: "\00a0"
}

.docs-layout pre>code:before, .docs-layout pre>code:after {
	letter-spacing: 0;
	content: ""
}
...
.token.cr:before, .token.lf:before {
	display: none
}
...
.started .content h3, .started .content h4 {
	display: table-cell;
	font-size: 15px;
	padding-right: 60px;
	line-height: 25px;
...
.started .content, .styles .content, .faq .content {
	padding: 40px;
	display: inline-block;
	text-align: left;
	width: 100%;
...
.styles .content li:before, .docs-readme .content li:before {
	position: absolute;
	top: 2px;
	left: -28px;
	content: '•';
...
@media ( max-width :850px) {
	...
	.started .section-content, .started pre {
		display: block
	}
	.started pre {
		width: auto
	}
	.started pre, .started .caption {
		margin-left: -40px;
		margin-right: -40px;
		max-width: none;
...
.styles .styles__ribbon, .styles .styles__ribbon>.ribbon__imagecontainer
	{
	display: -webkit-flex;
	display: -ms-flexbox;
	display: flex;
...
.styles .content ul, .components .content ul {
	font-size: 13px
}
...
@media ( -webkit-min-device-pixel-ratio :2) , ( min--moz-device-pixel-ratio :2) ,
	...
	.templates .docs-layout-header, .showcase .docs-layout-header {
...
.components .content blockquote:before, .components .content blockquote:after
	{
	display: none
}
