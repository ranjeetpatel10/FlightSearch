...
<p>
	The Material Design Lite (MDL) <strong>grid</strong> component is a
	simplified method for laying out content for multiple screen sizes. It
	reduces the usual coding burden required to correctly display blocks of
	content in a variety of display conditions.
</p>
<p>The MDL grid is defined and enclosed by a container element. A
	grid has 12 columns in the desktop screen size, 8 in the tablet size,
	and 4 in the phone size, each size having predefined margins and
	gutters. Cells are laid out sequentially in a row, in the order they
	are defined, with some exceptions:</p>
<ul>
	<li>If a cell doesn&#39;t fit in the row in one of the screen
		sizes, it flows into the following line.</li>
	<li>If a cell has a specified column size equal to or larger than
		the number of columns for the current screen size, it takes up the
		entirety of its row.</li>
</ul>
<p>
	You can set a maximum grid width, after which the grid stays centered
	with padding on either side, by setting its
	<code>max-width</code>
	CSS property.
</p>
<p>Grids are a fairly new and non-standardized feature in most user
	interfaces, and provide users with a way to view content in an
	organized manner that might otherwise be difficult to understand or
	retain. Their design and use is an important factor in the overall user
	experience.</p>
...
<p>
	&nbsp;1. Code a
	<code>&lt;div&gt;</code>
	element; this is the &quot;outer&quot; container, intended to hold all
	of the grid&#39;s cells. Style the div as desired (colors, font size,
	etc.).
</p>
<pre>
...
<p>&nbsp;3. For each cell, code one &quot;inner&quot; div, including
	the text to be displayed.</p>
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-grid&quot;&gt;
  &lt;div&gt;Content&lt;/div&gt;
  &lt;div&gt;goes&lt;/div&gt;
  &lt;div&gt;here&lt;/div&gt;
&lt;/div&gt;
...
<p>
	...
	class, where COLUMN specifies the column size for the cell, to the
	&quot;inner&quot; divs using the
	<code>class</code>
	attribute.
</p>
<pre>
...
<p>A grid with three cells, one of column size 6, one of column size
	4, and one of column size 2.</p>
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-grid&quot;&gt;
...
<p>A grid with three cells of column size 6 that will display as
	column size 8 on a tablet device.</p>
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-grid&quot;&gt;
...
<p>A grid with four cells of column size 2 that will display as
	column size 4 on a phone device.</p>
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-grid&quot;&gt;
...
<p>The MDL CSS classes apply various predefined visual enhancements
	and behavioral effects to the grid. The table below lists the available
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>N is 1-12 inclusive; optional on &quot;inner&quot; div
				elements</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>N is 1-11 inclusive; optional on &quot;inner&quot; div
				elements</td>
		</tr>
		<tr>
