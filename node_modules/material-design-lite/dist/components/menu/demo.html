...
.demo-menu.demo-menu__lower-left .bar {
	...
	padding: 16px;
		...
		<div class="container mdl-shadow--2dp">
			<div class="bar">{% include "lower-left.html" %}</div>
...
.demo-menu.demo-menu__lower-right .wrapper {
	...
	right: 16px;
		...
		<div class="container mdl-shadow--2dp">
			<div class="bar">
				<div class="wrapper">{% include "lower-right.html" %}</div>
			</div>
			<div class="background"></div>
		</div>
...
.demo-menu.demo-menu__top-left .bar {
	...
	padding: 16px;
		...
		<div class="container mdl-shadow--2dp">
			<div class="background"></div>
			<div class="bar">{% include "top-left.html" %}</div>
		</div>
...
.demo-menu.demo-menu__top-right .wrapper {
	...
	right: 16px;
		...
		<div class="container mdl-shadow--2dp">
			<div class="background"></div>
			<div class="bar">
				<div class="wrapper">{% include "top-right.html" %}</div>
			</div>
		</div>
