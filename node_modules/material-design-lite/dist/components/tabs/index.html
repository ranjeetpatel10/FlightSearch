...
<p>
	The Material Design Lite (MDL) <strong>tab</strong> component is a user
	interface element that allows different content blocks to share the
	same screen space in a mutually exclusive manner. Tabs are always
	presented in sets of two or more, and they make it easy to explore and
	switch among different views or functional aspects of an app, or to
	browse categorized data sets individually. Tabs serve as
	&quot;headings&quot; for their respective content; the <em>active</em>
	tab &mdash; the one whose content is currently displayed &mdash; is
	always visually distinguished from the others so the user knows which
	heading the current content belongs to.
</p>
<p>
	Tabs are an established but non-standardized feature in user
	interfaces, and allow users to view different, but often related,
	blocks of content (often called <em>panels</em>). Tabs save screen real
	estate and provide intuitive and logical access to data while reducing
	navigation and associated user confusion. Their design and use is an
	important factor in the overall user experience. See the tab
	component&#39;s <a
...
<p>
	&nbsp;1. Code a
	<code>&lt;div&gt;</code>
	element; this is the &quot;outer&quot; div, intended to contain all of
...
<p>&nbsp;2. Inside the &quot;outer&quot; div, code one
	...
	tab&#39;s content, all siblings. That is, for three content tabs, you
	would code four &quot;inner&quot; divs.</p>
<pre>
	<code class="lang-html">&lt;div&gt;
  &lt;div&gt;
  ...
...
<p>
	&nbsp;3. Inside the first &quot;inner&quot; div (the tabs), code one
	anchor
	<code>&lt;a&gt;</code>
...
<p>&nbsp;4. Inside the remaining &quot;inner&quot; divs, code the
	content you intend to display in each panel; use standard HTML tags to
	structure the content as desired.</p>
<pre>
	<code class="lang-html">&lt;div&gt;
  &lt;div&gt;
    &lt;a href=&quot;#tab1&quot;&gt;Tab One&lt;/a&gt;
...
<p>
	...
	&quot;outer&quot; and &quot;inner&quot; divs using the
	<code>class</code>
...
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-tabs mdl-js-tabs&quot;&gt;
...
<pre>
	<code class="lang-html">&lt;div class=&quot;mdl-tabs mdl-js-tabs mdl-js-ripple-effect&quot;&gt;
  &lt;div class=&quot;mdl-tabs__tab-bar&quot;&gt;
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>Required on one (and only one) of the &quot;inner&quot; div
				(tab) elements</td>
		</tr>
		<tr>
