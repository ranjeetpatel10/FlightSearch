...
.demo-typography--white, .demo-typography--black,
	.demo-typography--img-1, .demo-typography--img-2 {
	width: 360px;
	height: 272px;
	padding: 16px;
...
<body>
	...
	<div style="padding-top: 24px;">
		...
		<div class="demo-preview-block demo-page--typography">
			<table>
				...
				<tr>
					...
					<td class="mdl-typography--subhead">Regular 16px (Device),
						Regular 15px (Desktop)</td>
				</tr>
				<tr>
					<th class="mdl-typography--caption-color-contrast">Body 2</th>
					<td class="mdl-typography--body-2">Medium 14px (Device),
						Medium 13px (Desktop)</td>
				</tr>
				<tr>
					<th class="mdl-typography--caption-color-contrast">Body 1</th>
					<td class="mdl-typography--body-1">Regular 14px (Device),
						Regular 13px (Desktop)</td>
				</tr>
				<tr>
					<th class="mdl-typography--caption-color-contrast">Body 2
						(force preferred font)</th>
					<td class="mdl-typography--body-2-force-preferred-font">Medium
						14px (Device), Medium 13px (Desktop)</td>
				</tr>
				<tr>
					<th class="mdl-typography--caption-color-contrast">Body 1
						(force preferred font)</th>
					<td class="mdl-typography--body-1-force-preferred-font">Regular
						14px (Device), Regular 13px (Desktop)</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="mdl-typography--menu">Medium 14px (Device), Medium
						13px (Desktop)</td>
				</tr>
				<tr>
		...
		<div class="demo-preview-block">
			...
			<p class="mdl-typography--body-2">&lt;p
				class="mdl-typography-body-2"&gt;</p>

			<p class="mdl-typography--caption">&lt;p
				class="mdl-typography-caption"&gt;</p>

			<p class="mdl-typography--menu">&lt;p
				class="mdl-typography-menu"&gt;</p>

			<p class="mdl-typography--button">&lt;p
				class="mdl-typography-button"&gt;</p>

			<h3>Subtitles</h3>

			<h1>
				&lt;h1&gt; <small>Subtitle</small>
			</h1>
			<h2>
				&lt;h2&gt; <small>Subtitle</small>
			</h2>
			<h3>
				&lt;h3&gt; <small>Subtitle</small>
			</h3>
			<h4>
				&lt;h4&gt; <small>Subtitle</small>
			</h4>
			<h5>
				&lt;h5&gt; <small>Subtitle</small>
			</h5>
			<h6>
				&lt;h6&gt; <small>Subtitle</small>
			</h6>
		...
		<address>
			<strong>Googleplex</strong><br> 1600 Amphitheatre Pkwy<br>
			Mountain View, CA 94043<br> <abbr title="Phone">P:</abbr> (650)
			253-0000
		</address>
		...
		<p>Use &lt;pre&gt; for multi-line code blocks.
		<pre>
