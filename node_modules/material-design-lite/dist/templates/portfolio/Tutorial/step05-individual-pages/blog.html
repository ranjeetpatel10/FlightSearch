			...
			<div class="mdl-layout__header-row portfolio-navigation-row">
				<nav
					...
					<a class="mdl-navigation__link" href="index.html">Portfolio</a> <a
						class="mdl-navigation__link is-active" href="blog.html">Blog</a> <a
		...
		<div class="mdl-grid portfolio-max-width">
			<div
				...
				<div class="mdl-card__media mdl-cell mdl-cell--12-col-tablet">
					<img class="article-image" src=" ../../images/example-blog01.jpg"
						border="0" alt="">
				</div>
				<div class="mdl-cell mdl-cell--8-col">
					<h2 class="mdl-card__title-text">Velit anim eiusmod labore sit
						amet</h2>
					...
					<div class="mdl-card__supporting-text no-left-padding">
						<p>Excepteur reprehenderit sint exercitation ipsum consequat
							...
							adipisicing aliquip minim anim labore commodo.</p>
			...
			<div
				...
				<div class="mdl-card__media">
					<a href="#"> <img class="article-image"
						src=" ../../images/example-blog02.jpg" border="0" alt=""></a>
				</div>
			...
			<div
				...
				<div class="mdl-card__media">
					<a href="#"> <img class="article-image"
						src=" ../../images/example-blog04.jpg" border="0" alt=""></a>
				</div>
				<div class="mdl-card__supporting-text">
					<small>Excepteur reprehenderit sint exercitation ipsum
						consequat qui sit id velit elit.</small>
				</div>
				<div class="mdl-card__supporting-text">
					<p>Velit anim eiusmod labore sit amet. Voluptate voluptate
						irure occaecat deserunt incididunt esse in. Qui ullamco
						consectetur aute fugiat officia ullamco proident Lorem ad irure.
						Sint eu ut consectetur ut esse veniam.</p>
				</div>
			</div>
			<div
