...
<div class="demo-preview-block demo-page--typography">
	<table>
		...
		<tr>
			...
			<td class="mdl-typography--body-2">Medium 14px (Device), Medium
				13px (Desktop)</td>
		</tr>
		<tr>
		...
		<tr>
			<th class="mdl-typography--caption-color-contrast">Body 2 (force
				preferred font)</th>
			<td class="mdl-typography--body-2-force-preferred-font">Medium
				14px (Device), Medium 13px (Desktop)</td>
		</tr>
		<tr>
			<th class="mdl-typography--caption-color-contrast">Body 1 (force
				preferred font)</th>
