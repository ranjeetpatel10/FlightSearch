...
<body>
	<div class='wrapper'>
		<div class='pad1'>
			<h1>
				<a href="../index.html">all files</a> / <a href="index.html">lib/</a>
				tmp.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">74.67% </span> <span class="quiet">Statements</span>
					<span class='fraction'>112/150</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">65.96% </span> <span class="quiet">Branches</span>
					<span class='fraction'>62/94</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">81.48% </span> <span class="quiet">Functions</span>
					<span class='fraction'>22/27</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">76.92% </span> <span class="quiet">Lines</span>
...
<span class="cstat-no" title="statement not covered">        if (tries-- &gt; 0) <span
								class="cstat-no" title="statement not covered">return _getUniqueName();</span></span>
&nbsp;
...
&nbsp;
    ...
    fs.open(name, CREATE_FLAGS, opts.mode || FILE_MODE, function _fileCreated(err, fd) {
      <span class="missing-if-branch" title="if path not taken">I</span>if (err) <span
								class="cstat-no" title="statement not covered">return cb(err);</span>
&nbsp;
...
function _prepareTmpDirRemoveCallback(name, opts) {
  var removeFunction = opts.unsafeCleanup ? <span
								class="branch-0 cbranch-no" title="branch not covered">_rmdirRecursiveSync </span>: fs.rmdirSync.bind(fs);
...
&nbsp;
  return function _cleanupCallback() {
    <span class="missing-if-branch" title="if path not taken">I</span>if (called) <span
...
&nbsp;
<span class="missing-if-branch" title="if path not taken">I</span>if (version[0] === 0 &amp;&amp; (<span
								class="branch-1 cbranch-no" title="branch not covered">version[1] &lt; 9 </span>|| <span
								class="branch-2 cbranch-no" title="branch not covered">version[1] === 9 </span>&amp;&amp; <span
								class="branch-3 cbranch-no" title="branch not covered">version[2] &lt; 5)</span>) {
<span class="cstat-no" title="statement not covered">  process.addListener('uncaughtException', <span
								class="fstat-no" title="function not covered">function _uncaughtExceptionThrown(err) {</span></span>
...
&nbsp;
process.addListener('exit', <span class="fstat-no"
								title="function not covered">function _exit(code) {</span>
<span class="cstat-no" title="statement not covered">  if (code) <span
								class="cstat-no" title="statement not covered">_uncaughtException = true;</span></span>
<span class="cstat-no" title="statement not covered">  _garbageCollector();</span>
});
&nbsp;
...
&nbsp;</pre></td>
	...
	<div class='footer quiet pad2 space-top1 center small'>
		Code coverage generated by <a href="http://istanbul-js.org/"
			target="_blank">istanbul</a> at Tue Sep 20 2016 12:42:12 GMT+0200
		(CEST)
	</div>
	</div>
