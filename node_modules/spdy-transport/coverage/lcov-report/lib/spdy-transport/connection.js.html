		...
		<div class='pad1'>
			...
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">84.62% </span> <span class="quiet">Statements</span>
					<span class='fraction'>330/390</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">81.28% </span> <span class="quiet">Branches</span>
					<span class='fraction'>152/187</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">79.63% </span> <span class="quiet">Functions</span>
					<span class='fraction'>43/54</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">85.33% </span> <span class="quiet">Lines</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (options.maxChunk === false) { <span
								class="cstat-no" title="statement not covered">state.maxChunk = Infinity }</span> else <span
								class="missing-if-branch" title="else path not taken">E</span>if (options.maxChunk === undefined) { state.maxChunk = transport.protocol.base.constants.DEFAULT_MAX_CHUNK } else {
<span class="cstat-no" title="statement not covered">    state.maxChunk = options.maxChunk</span>
  }
&nbsp;
  // Connection-level flow control
  var windowSize = options.windowSize || <span
								class="branch-1 cbranch-no" title="branch not covered">1 &lt;&lt; 20</span>
...
&nbsp;
  ...
  state.parser.on('error', <span class="fstat-no"
								title="function not covered">function (err) {</span>
<span class="cstat-no" title="statement not covered">    self._onParserError(err)</span>
  })
&nbsp;
  // Propagate framer errors
  state.framer.on('error', <span class="fstat-no"
								title="function not covered">function (err) {</span>
...
&nbsp;
  ...
  this.socket.on('error', <span class="fstat-no"
								title="function not covered">function onSocketError (e) {</span>
<span class="cstat-no" title="statement not covered">    self.emit('error', e)</span>
  })
&nbsp;
  this.socket.once('close', <span class="fstat-no"
								title="function not covered">function onclose () {</span>
...
&nbsp;
Connection.prototype._onParserError = <span class="fstat-no"
								title="function not covered">function _onParserError (err) {</span>
...
<span class="cstat-no" title="statement not covered">      if (this._isGoaway(frame.id)) { <span
...
&nbsp;
Connection.prototype._onWindowOverflow = <span class="fstat-no"
								title="function not covered">function _onWindowOverflow () {</span>
<span class="cstat-no" title="statement not covered">  var state = this._spdyState</span>
...
<span class="cstat-no" title="statement not covered">        if (callback) { <span
								class="cstat-no" title="statement not covered">return callback(err) }</span> else { <span
								class="cstat-no" title="statement not covered">return stream.emit('error', err) }</span></span>
      }
&nbsp;
      if (callback) {
        callback(null, stream)
...
&nbsp;
Connection.prototype.destroyStreams = <span class="fstat-no"
								title="function not covered">function destroyStreams (err) {</span>
<span class="cstat-no" title="statement not covered">  var state = this._spdyState</span>
<span class="cstat-no" title="statement not covered">  Object.keys(state.stream.map).forEach(<span
								class="fstat-no" title="function not covered">function (id) {</span></span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (uri.push &amp;&amp; <span
								class="branch-1 cbranch-no" title="branch not covered">!state.acceptPush)</span> {
<span class="cstat-no" title="statement not covered">    err = new Error(</span>
        'Can\'t send PUSH_PROMISE, other side won\'t accept it')
<span class="cstat-no" title="statement not covered">    process.nextTick(<span
								class="fstat-no" title="function not covered">function () {</span></span>
<span class="cstat-no" title="statement not covered">      if (callback) { <span
								class="cstat-no" title="statement not covered">callback(err) }</span> else {</span>
<span class="cstat-no" title="statement not covered">        stream.emit('error', err)</span>
      }
    })
<span class="cstat-no" title="statement not covered">    return stream</span>
