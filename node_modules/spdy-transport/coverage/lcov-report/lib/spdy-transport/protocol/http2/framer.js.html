...
<title>Code coverage report for
	lib/spdy-transport/protocol/http2/framer.js</title>
<meta charset="utf-8" />
		...
		<div class='pad1'>
			<h1>
				<a href="../../../../index.html">all files</a> / <a
					href="index.html">lib/spdy-transport/protocol/http2/</a> framer.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">96.15% </span> <span class="quiet">Statements</span>
					<span class='fraction'>225/234</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">86.73% </span> <span class="quiet">Branches</span>
				...
				<div class='fl pad1y space-right2'>
					<span class="strong">96.46% </span> <span class="quiet">Lines</span>
...
&nbsp;
  if (kind === 'request') {
    ...
    pairs.push({ name: ':status', value: (frame.status || <span
								class="branch-1 cbranch-no" title="branch not covered">200)</span> + '' })
  }
&nbsp;
  var self = this
...
&nbsp;
      buf.writeUInt32BE((priority.exclusive ? <span
								class="branch-0 cbranch-no" title="branch not covered">0x80000000 </span>: 0) |
                        priority.parent)
      buf.writeUInt8((priority.weight | 0) - 1)
    }, callback)
  }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken">I</span>if (frame.extra) { <span
								class="cstat-no" title="statement not covered">buf.write(frame.extra) }</span>
  }, callback)
}
&nbsp;
