...
<title>Code coverage report for
	lib/spdy-transport/protocol/spdy/framer.js</title>
<meta charset="utf-8" />
		...
		<div class='pad1'>
			<h1>
				<a href="../../../../index.html">all files</a> / <a
					href="index.html">lib/spdy-transport/protocol/spdy/</a> framer.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">91.84% </span> <span class="quiet">Statements</span>
					<span class='fraction'>225/245</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">81.55% </span> <span class="quiet">Branches</span>
					<span class='fraction'>84/103</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">93.18% </span> <span class="quiet">Functions</span>
					<span class='fraction'>41/44</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">92.05% </span> <span class="quiet">Lines</span>
...
&nbsp;
  ...
  var loweredHeaders = {}
  Object.keys(headers || <span class="branch-1 cbranch-no"
								title="branch not covered">{})</span>.map(function (key) {
...
<span class="cstat-no" title="statement not covered">    this.on('version', <span
...
Framer.prototype.dataFrame = function dataFrame (frame, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!this.version) {
<span class="cstat-no" title="statement not covered">    return this.on('version', <span
								class="fstat-no" title="function not covered">function () {</span></span>
...
&nbsp;
Framer.prototype.priorityFrame = <span class="fstat-no"
								title="function not covered">function priorityFrame (frame, callback) {</span>
