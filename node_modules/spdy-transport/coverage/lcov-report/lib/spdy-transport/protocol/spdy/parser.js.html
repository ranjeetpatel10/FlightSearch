...
<title>Code coverage report for
	lib/spdy-transport/protocol/spdy/parser.js</title>
<meta charset="utf-8" />
...
<body>
	<div class='wrapper'>
		<div class='pad1'>
			<h1>
				<a href="../../../../index.html">all files</a> / <a
					href="index.html">lib/spdy-transport/protocol/spdy/</a> parser.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">88.05% </span> <span class="quiet">Statements</span>
					<span class='fraction'>199/226</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">79.14% </span> <span class="quiet">Branches</span>
					<span class='fraction'>110/139</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">95.83% </span> <span class="quiet">Functions</span>
					<span class='fraction'>23/24</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">90.78% </span> <span class="quiet">Lines</span>
					<span class='fraction'>197/217</span>
				</div>
			</div>
		</div>
...
485
486</td>
					<td class="line-coverage quiet"><span
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">9084×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4542×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4542×</span>
<span class="cline-any cline-yes">4542×</span>
<span class="cline-any cline-yes">4542×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4541×</span>
<span class="cline-any cline-yes">4541×</span>
<span class="cline-any cline-yes">4541×</span>
<span class="cline-any cline-yes">4541×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2700×</span>
<span class="cline-any cline-yes">94×</span>
<span class="cline-any cline-yes">2606×</span>
<span class="cline-any cline-yes">342×</span>
<span class="cline-any cline-yes">2264×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-yes">2264×</span>
<span class="cline-any cline-yes">23×</span>
<span class="cline-any cline-yes">2241×</span>
<span class="cline-any cline-yes">36×</span>
<span class="cline-any cline-yes">2205×</span>
<span class="cline-any cline-yes">27×</span>
<span class="cline-any cline-yes">2178×</span>
...
&nbsp;
Parser.prototype.setMaxHeaderListSize = <span class="fstat-no"
								title="function not covered">function setMaxHeaderListSize (size) {</span>
  // http2-only
}
&nbsp;
// Only for testing
...
&nbsp;
  if (this.version === null &amp;&amp; header.control) {
    ...
    <span class="missing-if-branch" title="if path not taken">I</span>if (header.version !== 2 &amp;&amp; header.version !== 3) {
<span class="cstat-no" title="statement not covered">      return callback(new Error('Unsupported SPDY version: ' + header.version))</span>
    }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken">I</span>if ((header.flags &amp; constants.flags.FLAG_COMPRESSED) !== 0) {
<span class="cstat-no" title="statement not covered">      return callback(new Error('DATA compression not supported'))</span>
    }
&nbsp;
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken">I</span>if (header.type === 0x05) {
<span class="cstat-no" title="statement not covered">    callback(null, { type: 'NOOP' })</span>
  ...
  } else <span class="missing-if-branch" title="else path not taken">E</span>if (header.type === 0xf000) { // X-FORWARDED
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(offset)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('SynHead OOB'))</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered">      return callback(new Error('Missing `:method` and/or `:path` header'))</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken">I</span>if (stream &amp;&amp; !headers[':status']) {
<span class="cstat-no" title="statement not covered">      return callback(new Error('Missing `:status` header'))</span>
    }
&nbsp;
...
Parser.prototype.onHeaderFrames = function onHeaderFrames (body, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(offset)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('HEADERS OOB'))</span>
  }
&nbsp;
...
&nbsp;
  this.parseKVs(body, function (err, headers) {
    <span class="missing-if-branch" title="if path not taken">I</span>if (err) { <span
								class="cstat-no" title="statement not covered">return callback(err) }</span>
&nbsp;
    callback(null, {
      type: 'HEADERS',
      priority: {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken">I</span>if (!buffer.has(size)) { <span
								class="cstat-no" title="statement not covered">return callback(new Error('KV OOB')) }</span>
&nbsp;
...
&nbsp;
    function readString () {
      <span class="missing-if-branch" title="if path not taken">I</span>if (!buffer.has(size)) { <span
								class="cstat-no" title="statement not covered">return null }</span>
      var len = self.version === 2
        ? buffer.readUInt16BE()
        : buffer.readUInt32BE()
&nbsp;
      <span class="missing-if-branch" title="if path not taken">I</span>if (!buffer.has(len)) { <span
								class="cstat-no" title="statement not covered">return null }</span>
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken">I</span>if (key === null || value === null) {
<span class="cstat-no" title="statement not covered">        return callback(new Error('Headers OOB'))</span>
      }
&nbsp;
      if (self.version &lt; 3) {
...
Parser.prototype.onRSTFrame = function onRSTFrame (body, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(8)) { <span
								class="cstat-no" title="statement not covered">return callback(new Error('RST OOB')) }</span>
&nbsp;
  var frame = {
    type: 'RST',
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (frame.id === 0) {
<span class="cstat-no" title="statement not covered">    return callback(this.error(constants.error.PROTOCOL_ERROR,</span>
                               'Invalid stream id for RST'))
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (body.size !== 0) {
<span class="cstat-no" title="statement not covered">    frame.extra = body.take(body.size)</span>
  }
  callback(null, frame)
}
&nbsp;
Parser.prototype.onSettingsFrame = function onSettingsFrame (body, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(4)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('SETTINGS OOB'))</span>
  }
&nbsp;
  var settings = {}
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(number * 8)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('SETTINGS OOB#2'))</span>
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken">I</span>if (flags &amp; 0x2) { <span
								class="cstat-no" title="statement not covered">continue }</span>
&nbsp;
    var name = idMap[id]
&nbsp;
...
Parser.prototype.onPingFrame = function onPingFrame (body, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(4)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('PING OOB'))</span>
  }
&nbsp;
...
Parser.prototype.onGoawayFrame = function onGoawayFrame (body, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(8)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('GOAWAY OOB'))</span>
  }
&nbsp;
  callback(null, {
    type: 'GOAWAY',
...
Parser.prototype.onWindowUpdateFrame = function onWindowUpdateFrame (body,
                                                                    callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(8)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('WINDOW_UPDATE OOB'))</span>
  }
&nbsp;
  callback(null, {
    type: 'WINDOW_UPDATE',
...
Parser.prototype.onXForwardedFrame = function onXForwardedFrame (body,
                                                                callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(4)) {
<span class="cstat-no" title="statement not covered">    return callback(new Error('X_FORWARDED OOB'))</span>
  }
&nbsp;
  var len = body.readUInt32BE()
  <span class="missing-if-branch" title="if path not taken">I</span>if (!body.has(len)) { <span
								class="cstat-no" title="statement not covered">return callback(new Error('X_FORWARDED host length OOB')) }</span>
&nbsp;
  callback(null, {
...
&nbsp;</pre></td>
	...
	<div class='footer quiet pad2 space-top1 center small'>
		Code coverage generated by <a href="http://istanbul-js.org/"
			target="_blank">istanbul</a> at Thu Feb 02 2017 23:24:23 GMT+0000
		(WET)
	</div>
	</div>
