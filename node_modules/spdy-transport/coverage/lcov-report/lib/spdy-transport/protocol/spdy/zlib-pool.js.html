...
<title>Code coverage report for
	lib/spdy-transport/protocol/spdy/zlib-pool.js</title>
<meta charset="utf-8" />
		...
		<div class='pad1'>
			<h1>
				<a href="../../../../index.html">all files</a> / <a
					href="index.html">lib/spdy-transport/protocol/spdy/</a>
				zlib-pool.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">91.3% </span> <span class="quiet">Statements</span>
					<span class='fraction'>21/23</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">50% </span> <span class="quiet">Branches</span>
					<span class='fraction'>2/4</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">83.33% </span> <span class="quiet">Functions</span>
					<span class='fraction'>5/6</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">91.3% </span> <span class="quiet">Lines</span>
					<span class='fraction'>21/23</span>
				</div>
			</div>
		</div>
...
function createDeflate (version, compression) {
  var deflate = zlib.createDeflate({
    ...
    windowBits: 11,
    level: compression ? <span class="branch-0 cbranch-no"
								title="branch not covered">zlib.Z_DEFAULT_COMPRESSION </span>: zlib.Z_NO_COMPRESSION
  })
&nbsp;
  // For node.js v0.8
