...
<html lang="en">
<head>
<title>Code coverage report for lib/spdy-transport/stream.js</title>
<meta charset="utf-8" />
...
<body>
	<div class='wrapper'>
		<div class='pad1'>
			<h1>
				<a href="../../index.html">all files</a> / <a href="index.html">lib/spdy-transport/</a>
				stream.js
			</h1>
			<div class='clearfix'>
				<div class='fl pad1y space-right2'>
					<span class="strong">91.53% </span> <span class="quiet">Statements</span>
					<span class='fraction'>346/378</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">81.56% </span> <span class="quiet">Branches</span>
					<span class='fraction'>115/141</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">92.45% </span> <span class="quiet">Functions</span>
					<span class='fraction'>49/53</span>
				</div>
				<div class='fl pad1y space-right2'>
					<span class="strong">93.13% </span> <span class="quiet">Lines</span>
					<span class='fraction'>339/364</span>
				</div>
			</div>
		</div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">3049×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3049×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1546×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1546×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1546×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1658×</span>
...
&nbsp;
Stream.prototype._init = <span class="fstat-no"
								title="function not covered">function _init (socket) {</span>
...
function _send (stream, state, data, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (checkAborted(stream, state, callback)) {
...
&nbsp;
  if (avail === 0) {
    state.window.send.update(0, <span class="fstat-no"
								title="function not covered">function () {</span>
<span class="cstat-no" title="statement not covered">      self._split(data, offset, onChunk, callback)</span>
    })
    return
  }
&nbsp;
...
Stream.prototype._handleHeaders = function _handleHeaders (frame) {
  var state = this._spdyState
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!state.readable || this._readableState.ended) {
<span class="cstat-no" title="statement not covered">    state.framer.rstFrame({ id: this.id, code: 'STREAM_CLOSED' })</span>
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
...
Stream.prototype._handleResponse = function _handleResponse (frame) {
  var state = this._spdyState
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (frame.headers[':status'] === undefined) {
<span class="cstat-no" title="statement not covered">    state.framer.rstFrame({ id: this.id, code: 'PROTOCOL_ERROR' })</span>
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
...
&nbsp;
  var ended = false
  <span class="missing-if-branch" title="if path not taken">I</span>if (state.aborted) { <span
								class="cstat-no" title="statement not covered">ended = true }</span>
&nbsp;
...
&nbsp;
  // .abort() emits `close`
  <span class="missing-if-branch" title="if path not taken">I</span>if (state.aborted) {
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
  if ((!state.readable || this._readableState.ended) &amp;&amp;
...
&nbsp;
  // GOAWAY
  <span class="missing-if-branch" title="if path not taken">I</span>if (this.connection._isGoaway(push.id)) {
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
...
Stream.prototype.send = function send (callback) {
  var state = this._spdyState
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (state.sent) {
<span class="cstat-no" title="statement not covered">    var err = new Error('Stream was already sent')</span>
...
&nbsp;
  state.timeout.reset()
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!this._checkEnded(callback)) { <span
								class="cstat-no" title="statement not covered">return }</span>
&nbsp;
  var frame = {
    id: this.id,
    status: status,
  ...
  state.framer.responseFrame(frame, function (err) {
    self._hardUncork()
    <span class="missing-if-branch" title="if path not taken">I</span>if (callback) { <span
								class="cstat-no" title="statement not covered">callback(err) }</span>
  })
}
&nbsp;
...
&nbsp;
  state.timeout.reset()
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!this._checkEnded()) {
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
...
&nbsp;
  var delta = state.window.recv.getDelta()
  <span class="missing-if-branch" title="if path not taken">I</span>if (delta === 0) { <span
								class="cstat-no" title="statement not covered">return }</span>
&nbsp;
  state.framer.windowUpdateFrame({
    id: this.id,
...
&nbsp;
Stream.prototype.destroy = <span class="fstat-no"
								title="function not covered">function destroy () {</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken">I</span>if (state.aborted) {
<span class="cstat-no" title="statement not covered">    state.debug('id=%d already aborted', this.id)</span>
<span class="cstat-no" title="statement not covered">    if (callback) { <span
								class="cstat-no" title="statement not covered">process.nextTick(callback) }</span></span>
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
  state.aborted = true
...
Stream.prototype.pushPromise = function pushPromise (uri, callback) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!this._checkEnded(callback)) {
<span class="cstat-no" title="statement not covered">    return</span>
  }
&nbsp;
  var self = this
...
<span class="cstat-no" title="statement not covered">    if (err) { <span
								class="cstat-no" title="statement not covered">push.emit('error', err) }</span></span>
  })
  push._hardCork()
&nbsp;
  return push
